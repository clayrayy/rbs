...
AddItemForm.TypeSelector = function AddItemFormTypeSelector({ children, ...restProps }) {
    return <TypeSelector name='type' type='radio' {...restProps}>{children}</TypeSelector>
}

AddItemForm.TypeSelectorFrame = function AddItemFormTypeSelectorFrame({ children, ...restProps }) {
    return <TypeSelectorFrame name='type' type='radio' {...restProps}>{children}</TypeSelectorFrame>
}

AddItemForm.TypeButtonContainer = function AddItemFormTypeButtonContainer({ children, ...restProps }) {
