...
Accordion.IconContainer = function AccordionIconContainer({children, ...restProps}) {
...
Accordion.TitleContainer = function AccordionTitleContainer({children, ...restProps}) {
